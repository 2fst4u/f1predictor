...
def test_original():
    weights = np.array([0.6, 0.4, 0.3, 0.2, 0.8, 0.4, 0.2, 0.2, 0.2])
...
orig = test_original()
opt = test_optimized()
print(f"Original: {orig:.3f}s")
print(f"Optimized: {opt:.3f}s")
print(f"Speedup: {orig/opt:.1f}x")
