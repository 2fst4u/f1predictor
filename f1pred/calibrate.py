        ...
        try:
            ...
            self.current_weights = {
                ...
                "blending": {
                    ...
                    "current_season_weight": self.current_weights["blending"].get("current_season_weight", 4.0),
                    "current_season_qualifying_weight": self.current_weights["blending"].get("current_season_qualifying_weight", 10.0),
