                    ...
                    if (cached_hit := pred_cache.get(cache_inputs := {
                        ...
                        try:
                            ...
                            hist_X_train = build_hist_training_X(
                                ...
                                boost_factor=getattr(cfg.modelling.blending, "current_season_weight", 4.0),
                                qual_boost_factor=getattr(cfg.modelling.blending, "current_season_qualifying_weight", 10.0)
                            )
                        except Exception as e:
